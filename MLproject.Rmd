...
However, before that, I need to do the data clean, preprocess using normalization, principle component analysis. And then, to get the maximum accuracy and less biase, I will use cross validation.
...
Here, we use the principle components as variables to train and evaluate our model.
